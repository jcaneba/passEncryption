		...
		btnModify.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(PassManage.opciones.getSelection()!=null) {
					...
					rbRemove.setBounds(50, 150, 150, 23);
					rbUpdate.setBounds(50, 200, 150, 23);

					JPasswordField newPass=new JPasswordField();
					newPass.setBounds(200, 200, 160, 23);
					add(newPass);
						...
						public void actionPerformed(ActionEvent e) {
							if(opciones2.getSelection()!=null) {
								...
								if(rbUpdate.isSelected() && !new String(newPass.getPassword()).equals("")) {
									...
									FileManage.lineUpdate("update",optionId,encryptedPass);
									...
									FileManage.lineUpdate("delete",optionId,"");
